...
set_property PACKAGE_PIN W14 [get_ports {bt[3]}]
set_property PACKAGE_PIN W13 [get_ports {bt[2]}]
set_property PACKAGE_PIN P15 [get_ports {bt[1]}]
set_property PACKAGE_PIN M14 [get_ports {bt[0]}]
